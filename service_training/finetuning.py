...
def main():
    ...
    for ind, training_arguments_path in enumerate(training_arguments_paths):
        ...
        # cross validation and normal training are called in different ways
        if do_cross_validation:
            ...
            logging.warning("doing classic training")
            bibliome_finetune_on_dataset(
                args_dict
            )
